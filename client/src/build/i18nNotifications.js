...
angular.module("services.i18nNotifications").factory("i18nNotifications", [
  "localizedMessages", "notifications", function(localizedMessages, notifications) {
    var I18nNotifications, prepareNotification;
    prepareNotification = function(msgKey, type, interpolateParams, otherProperties) {
