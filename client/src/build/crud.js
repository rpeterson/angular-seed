...
angular.module("services.crud").factory("crudEditMethods", function() {
  return function(itemName, item, formName, successcb, errorcb) {
    ...
    mixin.save = function() {
      return this[itemName].$saveOrUpdate(successcb, successcb, errorcb, errorcb);
    };
    ...
    mixin.revertChanges = function() {
      return this[itemName] = angular.copy(this[itemName + "Copy"]);
    };
    ...
    mixin.remove = function() {
      if (this[itemName].$id()) {
        return this[itemName].$remove(successcb, errorcb);
      } else {
        return successcb();
      }
    };
